...
const string strMessageMagic = "Bitslice Signed Message:\n";
...
int64_t GetProofOfStakeReward(const CBlockIndex* pindexPrev, int64_t nCoinAge, int64_t nFees)
{
    ...
    if(nBestHeight >= 21600 && nBestHeight <= 69200){  // 1 first Months
      nSubsidy = 75 * COIN;
    } else if(nBestHeight >= 69200 && nBestHeight < 198800){  // 3 Months
      nSubsidy = 50 * COIN;
    } else if(nBestHeight >= 198800 && nBestHeight < 717200){  // 1 year
      nSubsidy = 25 * COIN;
    } else{
      nSubsidy = 10 * COIN;
    }
